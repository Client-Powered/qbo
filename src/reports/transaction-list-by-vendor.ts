...
export const transactionListByVendor_columnTypes = [
  "account_name",
  "create_by",
  "create_date",
  "cust_msg",
...
export const transactionListByVendor = z.object({
  ...
  columns: z.enum(transactionListByVendor_columnTypes).optional(),
  sort_by: z.enum(transactionListByVendor_columnTypes).optional(),
  printed: z.enum([ "Printed", "To_be_printed" ]),
  cleared: z.enum([ "Cleared", "Uncleared", "Reconciled", "Deposited" ]),
